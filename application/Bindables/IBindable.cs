using minecraft.Application.Extensions.TypeExtensions;
...
public interface IBindable : ICanBeDisabled, IHasDefaultValue, IUnbindable, IHasDescription
{
        ...
        where T : IBindable
    {
        ...
        {
            throw new InvalidOperationException($"Attempted to create a copy of {source.GetType().ReadableName()}, but the returned instance type was {copy.GetType().ReadableName()}. "
